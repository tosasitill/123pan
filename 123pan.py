...
class Pan123:
    ...
    def up_load(self, filePath):
        ...
        listUpRequest = {"driveId": 0, "etag": readable_hash, "fileName": fileName,
                         "parentFileId": self.parentFileId, "size": fsize, "type": 0, "duplicate": 0}
    ...
    def mkdir(self, dirname, remakedir=False):
        ...
        dataMk = {"driveId": 0, "etag": "", "fileName": dirname, "parentFileId": self.parentFileId, "size": 0,
        ...
        if code == 0:
            print("创建成功: ", resJson["data"]["FileId"])
            self.get_dir()
